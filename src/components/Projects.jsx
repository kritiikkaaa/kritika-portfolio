...
const projects = [
  ...
  },
  {
    ...
    tags: ["Python", "Web Scraping", "Automation", "PDF Generation"],
        ...
        <div className="grid gap-8 lg:grid-cols-2">
          {projects.map((project, index) => (
            <motion.div
              ...
              className={`project-card glass-card overflow-hidden p-0 ${project.featured ? "lg:col-span-2" : ""}`}
            >
              <div
                className={
                  project.featured
              ...
              >
                <div className={project.featured ? "order-2 lg:order-1" : ""}>
                  <img
                    src={project.image}
                    alt={project.title}
                    className={`w-full object-cover ${project.featured ? "h-full min-h-[280px]" : "h-48"}`}
                  />
                </div>
                <div
                  className={`p-8 ${project.featured ? "order-1 lg:order-2" : ""}`}
                >
                  {project.featured && (
                  ...
                  <div className="mt-8 flex flex-wrap gap-3">
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      className="project-link rounded-full bg-cyan-400/90 px-5 py-2.5 font-medium text-slate-950 transition hover:bg-cyan-300"
                    >
                      Live Demo
                    </a>
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      className="project-link rounded-full border border-white/15 px-5 py-2.5 font-medium text-white transition hover:border-cyan-400 hover:text-cyan-300"
                    >
                      GitHub Repo
                    </a>
                  </div>
