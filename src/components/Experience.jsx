...
const experiences = [
  ...
  {
    title: "R Data Analyst Intern",
    company: "Yuva Intern by Henry Harvin",
    period: "Jul 2026 — Aug 2026",
    points: [
      "Performed data cleaning and preprocessing using R to improve data quality and consistency.",
      "Created data visualizations in R to identify patterns, trends, and insights from datasets.",
      "Applied R-based data analysis techniques to transform raw data into meaningful insights.",
    ],
  },
  {
        ...
        <div className="space-y-6">
          {experiences.map((item, index) => (
            <motion.div
              ...
              className="experience-card glass-card p-8"
            >
